...
|---|---|---|
| **1. End-to-End Pipeline** | [`1_end_to_end_pipeline.md`](1_end_to_end_pipeline.md)<br>[`front_end_screenshots/`](front_end_screenshots/)<br>[`back_end_screenshots/`](back_end_screenshots/) | Full architectural specifications, Sub-1B parameter sequence labeler (`124,400,000` params), deterministic date shifter ($\Delta t' = \Delta t$), eponym disambiguation, live cloud foundation LLM adapters (Google Gemini `gemini-3.6-flash`), rehydration engine, standalone web UI on port `3000`, and full frontend/backend visual proof galleries. |
